										...
										<div class="memory_limit">
											<p>
												...
												printf(
													...
													'//www.themeocean.net/common-issues-with-installing-wordpress-data-sample-and-solutions/'
												);
												?>
											</p>
										</div>
                        ...
                        <td colspan="2">
                           ...
                           <ul class="preview-demos">
	                           	<?php foreach( $remotes as  $remote ){ ?>
	                           		<li>
	                           		<a class="demo-item" href="<?php echo admin_url( 'themes.php?page=pbrthemer_options_import_page', 'http' ); ?>&package=<?php echo $remote['name'];?>&doaction=download">
