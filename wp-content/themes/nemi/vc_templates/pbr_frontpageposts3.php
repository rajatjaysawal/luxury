...
<section class="widget frontpage-posts frontpage-3 section-blog <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
    <?php
        if($title!=''){ ?>
         ...
         ?>
                ...
                <?php } else { ?>
                        ...
                        <div class="secondary-posts">
                            <?php }  ?>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 post-items">
